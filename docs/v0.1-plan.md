...
- GET `/sessions/:id/log?tail=200` — last N lines (default 200)
...
- Session Detail `/sessions/:id` — transcript view, input box, indicator when a turn is in flight, log tail panel (poll every 5–10s), cancel button
